 ...
 */
return array(
	'title'      => __( 'Core Archive Hero', 'vorfolio' ),
...
<div class="wp-block-column"><!-- wp:query-title {"type":"archive","textAlign":"center","level":2,"textColor":"white","className":"vorfolio-animate vorfolio-move-up","fontSize":"heading-2"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
