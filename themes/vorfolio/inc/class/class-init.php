...
class Init {
	...
	public function template_path( $template_file, $theme_slug, $template_slug ) {
		...
		switch ( $template_slug ) {
			...
			case 'project-details':
				return $directory . '/gutenverse-templates/templates/project-details.html';
			case 'projects':
			...
			case 'team':
				return $directory . '/gutenverse-templates/templates/team.html';
		}
	...
	public function notice_install_plugin() {
		...
		$button_text = __( 'Check it Now!', 'vorfolio' );
		...
		<style>
			.install-gutenverse-plugin-notice {
				...
				position: relative;
				overflow: hidden;
				background-image: url(<?php echo esc_url( VORFOLIO_URI . '/assets/images/mockup-2x.webp' ); ?>);
		...
		<div class="notice is-dismissible install-gutenverse-plugin-notice">
			<div class="gutenverse-notice-inner">
				<div class="gutenverse-notice-content">
					<h3><?php esc_html_e( 'Thank you for installing Vorfolio!', 'vorfolio' ); ?></h3>
					<p><?php esc_html_e( 'Vorfolio theme work best with Gutenverse plugin. By installing Gutenverse plugin you may access Vorfolio templates built with Gutenverse and get access to more than 40 free blocks.', 'vorfolio' ); ?></p>
					<div class="gutenverse-bottom">
						...
						<?php esc_html_e( 'More Info', 'vorfolio' ); ?>
	...
	public function dashboard_scripts() {
		...
		if ( 'appearance_page_vorfolio-dashboard' === $screen->id ) {
			...
			wp_localize_script( 'vorfolio-dashboard', 'GutenThemeConfig', $this->theme_config() );
		}
	}
	...
	public function theme_config() {
		return array(
			'images'       => VORFOLIO_URI . '/assets/img/',
			'title'        => esc_html__( 'Get Advanced Templates for Free!', 'vorfolio' ),
			'description'  => esc_html__( 'By just installing and activate Gutenverse plugin you will be able to use this theme\'s advanced templates. With Gutenverse plugin installed, you gain access to both advance version of templates and block patterns for free which all built using Gutenverse blocks.', 'vorfolio' ),
			'title2'       => esc_html__( 'Comparison using Gutenverse vs WordPress Core', 'vorfolio' ),
			'title3'       => esc_html__( 'Benefits for Installing Vorfolio\'s Gutenverse Version', 'vorfolio' ),
			'description3' => esc_html__( 'You can customize your website instantly with powerful and lightweight add-ons plugin for Gutenberg/FSE.', 'vorfolio' ),
			'note'         => esc_html__( 'Note: Clicking the button will both install and activate Gutenverse plugin and templates for this theme. Please first backup your current templates if you have any changes to it.', 'vorfolio' ),
			'note2'        => esc_html__( 'Note 2: (Gutenverse version 1.7.0 & above required!)', 'vorfolio' ),
			'demo'         => esc_html__( 'View Live Demo →', 'vorfolio' ),
			'demoUrl'      => esc_url( 'https:/gutenverse.com/demo?name=vorfolio' ),
			'install'      => '',
			'installText'  => esc_html__( 'Install Gutenverse Plugin', 'vorfolio' ),
			'activateText' => esc_html__( 'Activate Gutenverse Plugin', 'vorfolio' ),
			'doneText'     => esc_html__( 'Gutenverse Plugin Installed', 'vorfolio' ),
			'pages'        => array(
			...
			'table'        => array(
				'titles'   => array(
					null,
					esc_html__( 'Gutenverse (FREE)', 'vorfolio' ),
					esc_html__( 'WordPress Core', 'vorfolio' ),
				),
				'features' => array(
					esc_html__( 'Advanced Templates', 'vorfolio' ),
					esc_html__( 'Responsive Styling', 'vorfolio' ),
					esc_html__( 'Variety of Fonts', 'vorfolio' ),
					esc_html__( 'Icon Library', 'vorfolio' ),
					esc_html__( 'Animation Effects', 'vorfolio' ),
					esc_html__( 'Form Builder', 'vorfolio' ),
				),
			),
			'benefits'     => array(
				'title'    => esc_html__( 'Features', 'vorfolio' ),
				'features' => array(
					esc_html__( 'Modern and clean design', 'vorfolio' ),
					esc_html__( '5+ Ready to use templates', 'vorfolio' ),
					esc_html__( '15+ template parts', 'vorfolio' ),
					esc_html__( 'Fully responsive layout', 'vorfolio' ),
					esc_html__( 'Fully customizable', 'vorfolio' ),
				),
			),
		);
	}
