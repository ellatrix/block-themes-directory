 ...
 * Slug: greenshift/query-simple-list
 * Categories: greenshift-query
 * Block Types: core/query
 */
?>
<!-- wp:query {"queryId":46,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","categoryIds":[],"tagIds":[],"order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list","columns":3},"className":"is-style-default"} -->
