...
define('MONGOOSE_THEME_URL','https://wwwows.com/product/mongoose-wordpress-theme/');
define('MONGOOSE_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('MONGOOSE_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'mongoose_admin_theme_page_more_features' ) ) {
	function mongoose_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Mongoose Premium', 'mongoose' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'mongoose' ); ?></p>
    <a href="<?php echo esc_url(MONGOOSE_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Mongoose Premium', 'mongoose' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'mongoose_admin_theme_page_title' ) ) {
	function mongoose_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Mongoose WordPress Theme', 'mongoose' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Mongoose! Check all the theme features.', 'mongoose' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'mongoose' );?></h2>
</div>
<?php
	}
}    
 
// Mongoose admin page content   
if ( ! function_exists( 'mongoose_admin_theme_page' ) ) {
	function mongoose_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php mongoose_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Mongoose features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(MONGOOSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'mongoose' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(MONGOOSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'mongoose' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(MONGOOSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'mongoose' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(MONGOOSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'mongoose' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(MONGOOSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'mongoose' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Mongoose features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'mongoose' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Mongoose premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'mongoose' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'mongoose' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php mongoose_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'mongoose' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'mongoose' ); ?></p>
        <a href="<?php echo esc_url(MONGOOSE_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'mongoose' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'mongoose' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'mongoose' ); ?></p>
        <a href="<?php echo esc_url(MONGOOSE_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'mongoose' ); ?></a>
    </div>
</div>
<?php
	}
