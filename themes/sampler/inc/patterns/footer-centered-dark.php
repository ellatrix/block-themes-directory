<?php
return array(
			'title'         => __( 'Footer Centered (dark)', 'sampler' ),
			'categories'    => array( 'sampler-footers' ),
			'blockTypes'    => array( 'core/template-part/footer' ),
			'viewportWidth' => 1200,
			'content'       => '
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"4em","bottom":"4em"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"black","textColor":"light-gray","className":"site-footer","layout":{"inherit":false}} -->
<div class="wp-block-group alignfull site-footer has-light-gray-color has-black-background-color has-text-color has-background has-link-color" style="padding-top:4em;padding-bottom:4em"><!-- wp:group -->
