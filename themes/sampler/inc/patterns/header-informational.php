<?php
return array(
			'title'         => __( 'Header Informational (full)', 'sampler' ),
...
<div class="wp-block-group alignfull has-black-background-color has-background" style="padding-top:1em;padding-right:2rem;padding-bottom:0em;padding-left:2rem"><!-- wp:group {"align":"full","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
...
<!-- wp:separator {"align":"full","backgroundColor":"vivid-pink","className":"is-style-wide"} -->
<hr class="wp-block-separator alignfull has-text-color has-vivid-pink-color has-alpha-channel-opacity has-vivid-pink-background-color has-background is-style-wide"/>
<!-- /wp:separator -->

<!-- wp:group {"align":"full","className":"is-style-zero-top-margin","layout":{"type":"flex","justifyContent":"space-between"}} -->
<div class="wp-block-group alignfull is-style-zero-top-margin">
