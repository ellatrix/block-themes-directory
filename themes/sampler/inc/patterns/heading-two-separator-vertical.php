<?php
return array(
			'title'         => __( 'Heading with vertical separators', 'sampler' ),
			'categories'    => array( 'sampler-headlines' ),
			'viewportWidth' => 1200,
			'content'       => '
<!-- wp:group {"align":"wide","layout":{"type":"flex","allowOrientation":false,"flexWrap":"nowrap","justifyContent":"center"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"5px","bottom":"40px","left":"5px"}}},"backgroundColor":"vivid-purple"} -->
<div class="wp-block-group has-vivid-purple-background-color has-background" style="padding-top:40px;padding-right:5px;padding-bottom:40px;padding-left:5px"></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
',
