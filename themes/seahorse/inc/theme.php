...
define('SEAHORSE_THEME_URL','https://wwwows.com/product/seahorse-wordpress-theme/');
define('SEAHORSE_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('SEAHORSE_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'seahorse_admin_theme_page_more_features' ) ) {
	function seahorse_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Seahorse Premium', 'seahorse' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'seahorse' ); ?></p>
    <a href="<?php echo esc_url(SEAHORSE_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Seahorse Premium', 'seahorse' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'seahorse_admin_theme_page_title' ) ) {
	function seahorse_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Seahorse WordPress Theme', 'seahorse' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Seahorse! Check all the theme features.', 'seahorse' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'seahorse' );?></h2>
</div>
<?php
	}
}    
 
// Seahorse admin page content   
if ( ! function_exists( 'seahorse_admin_theme_page' ) ) {
	function seahorse_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php seahorse_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Seahorse features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SEAHORSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'seahorse' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SEAHORSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'seahorse' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SEAHORSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'seahorse' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SEAHORSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'seahorse' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(SEAHORSE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'seahorse' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Seahorse features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'seahorse' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Seahorse premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'seahorse' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'seahorse' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php seahorse_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'seahorse' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'seahorse' ); ?></p>
        <a href="<?php echo esc_url(SEAHORSE_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'seahorse' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'seahorse' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'seahorse' ); ?></p>
        <a href="<?php echo esc_url(SEAHORSE_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'seahorse' ); ?></a>
    </div>
</div>
<?php
	}
