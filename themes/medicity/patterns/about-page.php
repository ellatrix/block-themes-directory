...
<!-- wp:pattern {"slug":"medicity/cover-with-post-title"} /-->
<!-- wp:pattern {"slug":"medicity/hero-content"} /-->
<!-- wp:pattern {"slug":"medicity/call-to-action"} /-->
<!-- wp:pattern {"slug":"medicity/what-we-do"} /-->
</div>
<!-- /wp:group -->
