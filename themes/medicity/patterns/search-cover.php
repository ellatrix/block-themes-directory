<?php
 /**
  * Title: Search Cover
  * Slug: medicity/search-cover
  * Categories: medicity
  */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/cta-banner.jpg","id":372,"focalPoint":{"x":"0.35","y":"0.38"},"customGradient":"linear-gradient(90deg,rgb(34,31,60) 30%,rgba(155,81,224,0.09) 93%)","align":"full","style":{"spacing":{"padding":{"top":"10vw","right":"30px","bottom":"10vw","left":"30px"}}}} -->
...
<h2 class="has-text-align-center"> <?php echo esc_html__( 'Search Now', 'medicity' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
