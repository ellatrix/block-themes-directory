...
<h3><?php echo esc_html__( 'Archive', 'gutenify-store' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"10px"}}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3} -->
<h3><?php echo esc_html__( 'Category', 'gutenify-store' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group -->
<div class="wp-block-group"><!-- wp:heading {"level":3} -->
<h3><?php echo esc_html__( 'Latest Posts', 'hello-store' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group -->
<div class="wp-block-group"><!-- wp:heading {"level":3} -->
<h3><?php echo esc_html__( 'Tags', 'hello-store' ); ?></h3>
<!-- /wp:heading -->
