...
/**
 * Title: Page Content
 * Slug: droplet/page-content
 * Categories: droplet, page-content
 */
?>

<!-- wp:group {"style":{"spacing":{"padding":{"top":"60px","bottom":"60px","right":"20px","left":"20px"},"margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"constrained"}} -->
