<?php
 /**
  * Title: Hidden 404
  * Slug: gutenify-civil/hidden-404
...
<?php echo esc_html__( '4', 'gutenify-civil' ); ?><mark style="background-color: rgba(0, 0, 0, 0); color: #01dacc" class="has-inline-color"><?php echo esc_html__( '0', 'gutenify-civil' ); ?></mark><?php echo esc_html__( '4', 'gutenify-civil' ); ?>
		</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'gutenify-civil' ); ?> </p>
<!-- /wp:paragraph -->
