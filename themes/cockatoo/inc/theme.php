...
define('COCKATOO_THEME_URL','https://wwwows.com/product/cockatoo-wordpress-theme/');
define('COCKATOO_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('COCKATOO_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'cockatoo_admin_theme_page_more_features' ) ) {
	function cockatoo_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Cockatoo Premium', 'cockatoo' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'cockatoo' ); ?></p>
    <a href="<?php echo esc_url(COCKATOO_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Cockatoo Premium', 'cockatoo' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'cockatoo_admin_theme_page_title' ) ) {
	function cockatoo_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Cockatoo WordPress Theme', 'cockatoo' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Cockatoo! Check all the theme features.', 'cockatoo' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'cockatoo' );?></h2>
</div>
<?php
	}
}    
 
// Cockatoo admin page content   
if ( ! function_exists( 'cockatoo_admin_theme_page' ) ) {
	function cockatoo_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php cockatoo_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Cockatoo features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(COCKATOO_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'cockatoo' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(COCKATOO_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'cockatoo' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(COCKATOO_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'cockatoo' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(COCKATOO_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'cockatoo' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(COCKATOO_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'cockatoo' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Cockatoo features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'cockatoo' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Cockatoo premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'cockatoo' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'cockatoo' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php cockatoo_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'cockatoo' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'cockatoo' ); ?></p>
        <a href="<?php echo esc_url(COCKATOO_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'cockatoo' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'cockatoo' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'cockatoo' ); ?></p>
        <a href="<?php echo esc_url(COCKATOO_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'cockatoo' ); ?></a>
    </div>
</div>
<?php
	}
