<?php
/**
 * Template Name: Layout Sidebar Right Template
 * 
...
<main id="primary" class="site-main">
	...
	<div class="np-container">
		<div class="np-layout-entries">
			<section class="np-layout-content-right">
				<?php
				/**
				...
				while ( have_posts() ) :
					...
					get_template_part( 'inc/template-parts/content', 'sidebar-right' );
			...
			<div id="secondary" aria-labelledby="secondary" class="np-layout-aside-right">
				<?php
				/**
