 ...
 */
return array(
	'title'      => esc_html__( 'Blog - Sidebar On Left', 'axton' ),
	...
	<div class="wp-block-columns alignwide wp-block-sidebar-on-left"><!-- wp:column {"width":"25%","className":"wp-block-column-sidebar"} -->
	<div class="wp-block-column wp-block-column-sidebar" style="flex-basis:25%"><!-- wp:template-part {"slug":"sidebar","theme":"axton","tagName":"div"} /--></div>
	<!-- /wp:column -->
	
	<!-- wp:column {"width":"75%"} -->
	<div class="wp-block-column" style="flex-basis:75%"><!-- wp:query {"queryId":0,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list"},"layout":{"inherit":true}} -->
