 ...
 */
return array(
	'title'      => esc_html__( 'Block Style Guide', 'axton' ),
	'categories' => array( 'axton' ),
	'content'    => '<!-- wp:heading {"level":1} -->
					...
					<!-- wp:preformatted {"className":"is-style-axton-wp-preformatted"} -->
<pre class="wp-block-preformatted is-style-axton-wp-preformatted">The Road Not Taken, by Robert Frost
...
<!-- /wp:preformatted -->
					...
					<!-- wp:verse {"className":"is-style-axton-wp-verse"} -->
					<pre class="wp-block-verse is-style-axton-wp-verse">This is an example of the core Gutenberg verse block.</pre>
					<!-- /wp:verse -->
					...
					<!-- wp:quote {"className":"is-style-axton-block-quote"} -->
					<blockquote class="wp-block-quote is-style-axton-block-quote"><p>Donec sed odio dui. Maecenas faucibus mollis interdum. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio.</p><cite>Rich Tabor</cite></blockquote>
					<!-- /wp:quote -->
					...
					<!-- wp:pullquote {"className":"is-style-axton-pullquote"} -->
					<figure class="wp-block-pullquote is-style-axton-pullquote"><blockquote><p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere est at lobortis.</p><cite>Rich Tabor, ThemeBeans.com</cite></blockquote></figure>
					<!-- /wp:pullquote -->
					...
					<!-- wp:pullquote {"align":"wide","className":"is-style-axton-pullquote"} -->
					<figure class="wp-block-pullquote alignwide is-style-axton-pullquote"><blockquote><p>Nulla vitae elit libero, a pharetra augue. Vestibulum id ligula porta felis euismod semper. Aenean lacinia bibendum nulla sed ibendum nulla sed consectetur.</p><cite>Rich Tabor, Founder at ThemeBeans.com</cite></blockquote></figure>
					<!-- /wp:pullquote -->
					...
					<!-- wp:pullquote {"align":"full","className":"is-style-axton-pullquote"} -->
					<figure class="wp-block-pullquote alignfull is-style-axton-pullquote"><blockquote><p>Nulla vitae elit libero, a pharetra augue. Vestibulum id ligula porta felis euismod semper. Aenean lacinia bibendum nulla sed ibendum nulla sed consectetur.</p><cite>Rich Tabor, Founder at ThemeBeans.com</cite></blockquote></figure>
					<!-- /wp:pullquote -->
					...
					<!-- wp:pullquote {"textAlign":"left","align":"left","className":"is-style-axton-pullquote"} -->
					<figure class="wp-block-pullquote alignleft has-text-align-left is-style-axton-pullquote"><blockquote><p>Here we have a left-aligned pullquote.</p><cite>Rich Tabor</cite></blockquote></figure>
					<!-- /wp:pullquote -->
					...
					<!-- wp:pullquote {"textAlign":"right","align":"right","className":"is-style-axton-pullquote"} -->
					<figure class="wp-block-pullquote alignright has-text-align-right is-style-axton-pullquote"><blockquote><p>Here we have a right-aligned pullquote.</p><cite>Rich Tabor</cite></blockquote></figure>
					<!-- /wp:pullquote -->
