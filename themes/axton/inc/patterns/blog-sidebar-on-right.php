 ...
 */
return array(
	'title'      => esc_html__( 'Blog - Sidebar On Right', 'axton' ),
	...
	<div class="wp-block-column" style="flex-basis:75%"><!-- wp:query {"queryId":1,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list"},"layout":{"inherit":true}} -->
