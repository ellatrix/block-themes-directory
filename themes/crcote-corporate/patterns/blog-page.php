<?php
 /**
  * Title: Blog Page
  * Slug: crcote-corporate/blog-page
  * Categories: crcote_blog
  */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull"><!-- wp:pattern {"slug":"crcote-corporate/cover-with-post-title"} /-->
...
<div class="wp-block-group"><!-- wp:post-author {"avatarSize":24,"showBio":false,"fontSize":"small"} /-->

<!-- wp:post-date {"format":"M j, Y","isLink":true,"fontSize":"small"} /--></div>
<!-- /wp:group -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:pattern {"slug":"crcote-corporate/primary-sidebar"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></main>
<!-- /wp:group --></div>
<!-- /wp:group -->