<?php
return array(
			'title'         => __( '2 columns with title and image', 'alara' ),
...
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:list {"className":"is-style-line"} -->
<ul class="is-style-line"><li>1/2 pound boiled fish</li><li>1/4 pound boiled rice</li><li>2 eggs</li><li>2 ounce butter</li></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:list {"className":"is-style-line"} -->
<ul class="is-style-line"><li>salt, to taste</li><li>cayenne pepper, to taste</li><li>nutmeg, to taste</li></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
