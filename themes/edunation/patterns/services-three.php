 ...
 * Slug: edunation/service-three
 * Categories: edunation_services
*/
?>
...
<div class="wp-block-group alignfull has-white-background-color has-background" style="padding-top:4vw;padding-right:4vw;padding-bottom:4vw;padding-left:4vw">
	...
	<h2 class="has-text-align-center"><?php _e( 'What we offer', 'edunation' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="border-style:solid;border-width:2px;padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
				...
				<!-- wp:heading {"level":3} -->
				<h3><?php _e( 'Service One', 'edunation' ); ?></h3>
				<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="border-style:solid;border-width:2px;padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
				...
				<!-- wp:heading {"level":3} -->
				<h3><?php _e( 'Service Two', 'edunation' ); ?></h3>
				<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="border-style:solid;border-width:2px;padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
				...
				<!-- wp:heading {"level":3} -->
				<h3><?php _e( 'Service Three', 'edunation' ); ?></h3>
				<!-- /wp:heading -->
