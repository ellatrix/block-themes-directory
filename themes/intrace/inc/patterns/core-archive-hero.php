...
<div class="wp-block-group" style="padding-top:100px;padding-bottom:200px"><!-- wp:query-title {"type":"archive","textAlign":"center","textColor":"intrace-accent","fontSize":"heading-4"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->',
);
