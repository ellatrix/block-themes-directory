...
return array(
	...
	'content'    => '<!-- wp:group {"tagName":"main","style":{"spacing":{"margin":{"bottom":"60px","top":"0px"},"padding":{"top":"60px"}}},"layout":{"contentSize":"960px"}} -->
                    <main class="wp-block-group" style="margin-top:0px;margin-bottom:60px;padding-top:60px"><!-- wp:query {"queryId":0,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":true},"displayLayout":{"type":"list","columns":3}} -->
