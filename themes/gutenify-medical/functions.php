...
function gutenify_medical_admin_scripts() {
	...
	// FontAwesome.
	wp_register_style( 'gutenify-medical-admin-style', get_stylesheet_directory_uri() . '/css/admin-style.css', $deps, date( 'Ymd-Gis', filemtime( get_theme_file_path( 'style.css' ) ) ) );
