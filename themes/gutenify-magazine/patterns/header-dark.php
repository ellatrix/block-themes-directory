<?php
 /**
  * Title: Header Dark
  * Slug: gutenify-magazine/header-dark
...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group alignfull">
		<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ) . '/images/header-banner.jpg'; ?>","id":681,"dimRatio":90,"overlayColor":"foreground","focalPoint":{"x":"0.94","y":"0.81"},"minHeight":240,"align":"full","style":{"spacing":{"padding":{"top":"0px","bottom":"0px"}}}} -->
		<div
			class="wp-block-cover alignfull"
			style="padding-top: 0px; padding-bottom: 0px; min-height: 240px"
		>
			<span
				aria-hidden="true"
				class="wp-block-cover__background has-foreground-background-color has-background-dim-90 has-background-dim"
			></span
			><img
					...
					>
						...
						>
							...
							<div class="wp-block-group">
								<!-- wp:site-title {"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"huge"} /-->
	...
	<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}},"color":{"background":"#191717"}},"layout":{"inherit":true}} -->
	<div
