<?php
 /**
  * Title: Post Listing Column Single
  * Slug: gutenify-magazine/post-listing-single-column
  * Categories: gutenify-magazine
  */
?>
<!-- wp:query {"queryId":1,"query":{"perPage":"8","pages":"","offset":"","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"tagName":"main","displayLayout":{"type":"list","columns":2},"align":"wide","layout":{"inherit":true}} -->
