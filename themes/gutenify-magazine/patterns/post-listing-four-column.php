<?php
 /**
  * Title: Post Listing Column Four
  * Slug: gutenify-magazine/post-listing-four-column
  * Categories: gutenify-magazine
  */
?>
<!-- wp:query {"queryId":1,"query":{"perPage":"8","pages":"","offset":"","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"tagName":"main","displayLayout":{"type":"flex","columns":4},"align":"wide","layout":{"inherit":true}} -->
