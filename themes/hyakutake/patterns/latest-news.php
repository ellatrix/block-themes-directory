...
<p class="has-text-align-center has-primary-color has-text-color"><?php echo esc_html__( 'From Our Blog', 'hyakutake' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","fontSize":"slider-title"} -->
<h2 class="has-text-align-center has-slider-title-font-size"><?php echo esc_html__( 'Recent News', 'hyakutake' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group alignwide has-background-background-color has-background" style="margin-top:0px;padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:post-title {"level":3,"isLink":true,"align":"wide","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} /-->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Explore More', 'hyakutake' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->