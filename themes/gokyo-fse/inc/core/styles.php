...
function gokyo_fse_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles[':hover']['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color--background: ' . gokyo_fse_get_color_value( $core_button_styles[':hover']['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles[':hover']['color']['text'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color: ' . gokyo_fse_get_color_value( $core_button_styles[':hover']['color']['text'] ) . ';';
	}
