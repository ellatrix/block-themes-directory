<?php
 /**
  * Title: Header Transparent With Cart
  * Slug: VisionArt/header-transparent-with-cart
  * Categories: VisionArt, header
  */
?>
<!-- wp:group {"align":"full","className":"transparent-header","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull transparent-header">
	<!-- wp:group {"align":"full","className":"header","layout":{"inherit":true,"type":"constrained"}} -->
