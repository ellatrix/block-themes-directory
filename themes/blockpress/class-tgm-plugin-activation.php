	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				...
				'installing'                      => esc_html__( 'Installing Plugin: %s', 'blockpress' ),
				/* translators: %s: plugin name. */
				'updating'                        => esc_html__( 'Updating Plugin: %s', 'blockpress' ),
				...
				'return'                          => esc_html__( 'Return to Required Plugins Installer', 'blockpress' ),
				'dashboard'                       => esc_html__( 'Return to the Dashboard', 'blockpress' ),
				'plugin_activated'                => esc_html__( 'Plugin activated successfully.', 'blockpress' ),
				'activated_successfully'          => esc_html__( 'The following plugin was activated successfully:', 'blockpress' ),
				/* translators: 1: plugin name. */
				'plugin_already_active'           => esc_html__( 'No action taken. Plugin %1$s was already active.', 'blockpress' ),
				/* translators: 1: plugin name. */
				'plugin_needs_higher_version'     => esc_html__( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'blockpress' ),
				/* translators: 1: dashboard link. */
				'complete'                        => esc_html__( 'All plugins installed and activated successfully. %1$s', 'blockpress' ),
				'dismiss'                         => esc_html__( 'Dismiss this notice', 'blockpress' ),
				'notice_cannot_install_activate'  => esc_html__( 'There are one or more required or recommended plugins to install, update or activate.', 'blockpress' ),
				'contact_admin'                   => esc_html__( 'Please contact the administrator of this site for help.', 'blockpress' ),
			);
