<?php
/**
 * Blockpress: Footer with text, links, buttons, black background
 *
 * @package Blockpress
 */

return array(
	'title'         => __( 'Simple 3 column dark footer', 'blockpress' ),
	'categories'    => array( 'blockpress-footer' ),
	'blockTypes'    => array( 'core/template-part/footer' ),
 
	'content'       => '<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|textondark"}}},"spacing":{"padding":{"top":"40px","bottom":"40px"}}},"backgroundColor":"dark","textColor":"textondark","layout":{"inherit":true},"fontSize":"small"} -->
				...
				<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#d6d9dc"}}}},"fontSize":"small"} -->
				<p><a href="#">' . esc_html__( 'Privacy Policy', 'blockpress' ) . '</a> · <a href="#">' . esc_html__( 'Terms of Service', 'blockpress' ) . '</a> · <a href="#">' . esc_html__( 'Contact Us', 'blockpress' ) . '</a></p>
				<!-- /wp:paragraph -->
