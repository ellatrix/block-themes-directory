 ...
 */
return array(
	'title'      => esc_html__( '404 Header', 'catch-fse' ),
    ...
    <div class="wp-block-group">
        ...
        <div class="wp-block-group alignwide">
            <!-- wp:heading {"textAlign":"center","level":1} -->
                <h1 class="has-text-align-center">' . esc_html__( '404 Nothing Found', 'catch-fse' ) . '</h1>
            <!-- /wp:heading -->
            <!-- wp:paragraph {"textAlign":"center"} -->
            <p class="has-text-align-center">' . esc_html__( 'Oops! That page can\'t be found', 'catch-fse' ) . '</p>
            <!-- /wp:paragraph -->
