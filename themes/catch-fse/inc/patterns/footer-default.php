 ...
 */
return array(
	'title'      => esc_html__( 'Default footer', 'catch-fse' ),
						...
						<div class="wp-block-group alignfull wp-block-footer  wp-block-site-generator">
							...
							<div class="wp-block-group alignwide wp-block-site-info">
								...
								<p>' .
									...
									' Copyright &copy; ' .date('Y') . esc_html__( '. Powered by %s', 'catch-fse' ),
									'<a href="' . esc_url( esc_html__( 'https://catchthemes.com', 'catch-fse' ) ) . '" rel="nofollow">Catch Themes</a>'
									) . '</p>
								<!-- /wp:paragraph -->
