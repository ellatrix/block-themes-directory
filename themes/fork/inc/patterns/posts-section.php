...
<h2 class="alignwide">' . __( 'Read these Posts', 'fork' ) . '</h2>
<!-- /wp:heading -->
...
<p class="has-ti-bg-alt-background-color has-background">' . __( 'No Posts were found', 'fork' ) . '</p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
