   ...
   <div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile">
      ...
      <div class="wp-block-media-text__content">
         ...
         <div class="wp-block-group wp-block-group-heading">
            ...
            <h6 style="text-transform:uppercase"><?php esc_html_e ( 'About Us', 'globetrotter' ) ?></h6>
            <!-- /wp:heading -->
            <!-- wp:heading -->
            <h2><?php esc_html_e ( 'Fresh ideas for every business', 'globetrotter' ) ?></h2>
            <!-- /wp:heading -->
         </div>
         <!-- /wp:group -->
         <!-- wp:paragraph -->
         <p><?php esc_html_e ( 'Lorem ipsum dolor sit amet, consectetur Integer pretium condimentum tristique aenean luctus mauris lorem ipsum dolor sit amet consectetur.', 'globetrotter' ) ?></p>
         <!-- /wp:paragraph -->
         <!-- wp:buttons -->
