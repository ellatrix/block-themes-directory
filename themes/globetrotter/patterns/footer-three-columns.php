<?php
  ...
  * Slug: globetrotter/footer-three-columns
         ...
         <div class="wp-block-columns wp-block-footer-widget-area-columns">
            ...
            <div class="wp-block-column wp-block-widget">
               ...
               <div class="wp-block-group">
                  ...
                  <h2 id="about" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e ( 'About', 'globetrotter' ) ?></h2>
                  <!-- /wp:heading -->
                  <!-- wp:paragraph -->
                  <p><?php esc_html_e ( 'Lorem ipsum dolor sit amet con sect etur adipiscing elit maecenas conse ctetur dapibus rutrum proin vitae nibh eget adipiscing elit maecenas cons.', 'globetrotter' ) ?></p>
                  <!-- /wp:paragraph -->
               </div>
               <!-- /wp:group --><!-- wp:group -->
               <div class="wp-block-group">
            ...
            <div class="wp-block-column wp-block-widget">
               ...
               <div class="wp-block-group">
                  <!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
                  <h2 id="contact" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e ( 'Contact', 'globetrotter' ) ?></h2>
                  <!-- /wp:heading -->
                  ...
                  <div class="wp-block-group">
                     ...
                     <!-- /wp:image -->
                     <!-- wp:paragraph -->
                     <p><a href="#"><?php esc_html_e ( '374 FA Tower, Williams S Blvd. 2721, IL, USA', 'globetrotter' ) ?></a></p>
                     <!-- /wp:paragraph -->
                  </div>
                  <!-- /wp:group -->
                  <!-- wp:group {"layout":{"type":"flex","allowOrientation":false}} -->
                  <div class="wp-block-group">
                     ...
                     <!-- /wp:image -->
                     <!-- wp:paragraph -->
                     <p><a href="#"><?php esc_html_e ( '(+880) 123 3456 7890', 'globetrotter' ) ?></a></p>
                     <!-- /wp:paragraph -->
                  </div>
                  <!-- /wp:group -->
                  <!-- wp:group {"layout":{"type":"flex","allowOrientation":false}} -->
                  <div class="wp-block-group">
                     ...
                     <!-- /wp:image -->
                     <!-- wp:paragraph -->
                     <p><a href="#"><?php esc_html_e ( 'info@companyname.com', 'globetrotter' ) ?></a></p>
                     <!-- /wp:paragraph -->
                  </div>
                  <!-- /wp:group -->
                  <!-- wp:group {"layout":{"type":"flex","allowOrientation":false}} -->
                  <div class="wp-block-group">
                     ...
                     <!-- /wp:image -->
                     <!-- wp:paragraph -->
                     <p><a href="#"><?php esc_html_e ( 'Opening Hours: 10:00 18:00', 'globetrotter' ) ?></a></p>
                     <!-- /wp:paragraph -->
                  </div>
                  <!-- /wp:group -->
               </div>
            ...
            <div class="wp-block-column wp-block-widget">
               ...
               <div class="wp-block-group">
                  <!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
                  <h2 id="recent-post" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e ( 'Recent Post', 'globetrotter' ) ?></h2>
                  <!-- /wp:heading -->
