<?php
  ...
  * Slug: globetrotter/header-with-buttons
      ...
      <div class="wp-block-group alignwide"
         ...
         <div class="wp-block-group">
            ...
            <div class="wp-block-buttons">
               ...
               <div class="wp-block-button is-style-button"><a class="wp-block-button__link"><?php esc_html_e ( 'Log in', 'globetrotter' ) ?></a></div>
               <!-- /wp:button -->
               <!-- wp:button {"className":"is-style-outline"} -->
               <div class="wp-block-button is-style-outline"><a class="wp-block-button__link"><?php esc_html_e ( 'Get Started', 'globetrotter' ) ?></a></div>
               <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
         </div>
