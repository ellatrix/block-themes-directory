...
<h1 class="has-text-color-foreground"><?php esc_html_e( '404 Nothing Found', 'rhythmic' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {} -->
<p><?php esc_html_e( 'Oops! That page can\'t be found', 'rhythmic' ); ?></p>
<!-- /wp:paragraph -->
