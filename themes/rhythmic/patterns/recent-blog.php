<?php
 /**
  * Title: Recent Blog
  * Slug: Rhythmic/recent-blog
  * Categories: Rhythmic, query
  */
?>
<!-- wp:group {"align":"full","className":"blog-section","layout":{"inherit":true}} -->
<div class="wp-block-group alignfull blog-section">
	<!-- wp:columns {"align":"wide","style":{"border":{"style":"solid"}}} -->
	<div class="wp-block-columns alignwide" style="border-style:solid">
		...
		<!-- /wp:column -->
		<!-- wp:column {"width":"22.9%"} -->
		<div class="wp-block-column" style="flex-basis:22.9%">
            ...
            commodo, rhoncus et ante..','rhythmic');?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:group {"className":"wp-block-widget"} -->
				<div class="wp-block-group wp-block-widget">
					<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
					<h2 id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Categories','rhythmic');?></h2>
					<!-- /wp:heading -->
					<!-- wp:categories /-->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group wp-block-widget">
					<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
					<h2 id="recent-post" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Recent Post','rhythmic');?></h2>
					<!-- /wp:heading -->
				...
				<div class="wp-block-group wp-block-widget">
					<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
					<h2 id="tags" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Tags','rhythmic');?></h2>
					<!-- /wp:heading -->
