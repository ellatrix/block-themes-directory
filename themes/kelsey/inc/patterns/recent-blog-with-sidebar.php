 ...
 */
return array(
	'title'      => esc_html__( 'Recent Blog With Sidebar', 'kelsey' ),
	'categories' => array( 'kelsey', 'query' ),
	...
	<div class="wp-block-column" style="flex-basis:68.572%"><!-- wp:query {"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","categoryIds":[],"tagIds":[],"order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"layout":{"inherit":true}} -->
	...
	<div class="wp-block-group alignfull wp-block-post-container"><!-- wp:post-terms {"term":"post_tag"} /-->
	...
	<div class="wp-block-column wp-block-column-sidebar" style="flex-basis:28.572%">
		<!-- wp:template-part {"slug":"sidebar","theme":"kelsey","tagName":"div"} /-->
	</div>
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div>
	<!-- /wp:group -->',
