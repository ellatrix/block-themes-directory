<?php
/**
 * Title: Blog Post List Query - Purple Backgrounds.
 * Slug: semplice-monospazio/list-blog-query-purple-backgrounds
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","right":"10px","bottom":"10px","left":"10px"}},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"backgroundColor":"dark-purple","textColor":"white","className":"list-blog-post"} -->
<div class="wp-block-group list-blog-post has-white-color has-dark-purple-background-color has-text-color has-background has-link-color" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px"><!-- wp:columns -->
