 ...
 * @return void
 */
function exo_get_color_value( $value ) {
...
function exo_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color--background: ' . exo_get_color_value( $core_button_styles['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles['color']['text'] ) ) {
		// var(--wp--preset--color--vivid-red)
		$element_css_styles .= '--wp--custom--core-button--color: ' . exo_get_color_value( $core_button_styles['color']['text'] ) . ';';
	}
	...
	if ( ! empty( $core_button_styles[':hover']['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color--background: ' . exo_get_color_value( $core_button_styles[':hover']['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles[':hover']['color']['text'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color: ' . exo_get_color_value( $core_button_styles[':hover']['color']['text'] ) . ';';
	}
...
add_action( 'wp_enqueue_scripts', 'exo_global_styles_vars', 100 );
